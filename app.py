...
logo_html = (
    f'<img src="data:image/jpeg;base64,{logo_b64}" width="100" style="margin-right:20px;"/>'
    if logo_b64 else ""
)
...
def load_data():
    ...
    Q1 = data['Company Tenure'].quantile(0.25)
    Q3 = data['Company Tenure'].quantile(0.75)
    IQR = Q3 - Q1
    upper = Q3 + 1.5 * IQR
    median_tenure = data['Company Tenure'].median()
    data.loc[data['Company Tenure'] > upper, 'Company Tenure'] = median_tenure
    return data.copy()
