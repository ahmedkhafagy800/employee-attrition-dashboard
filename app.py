...
logo_html = (
    f'<img src="data:image/jpeg;base64,{logo_b64}" width="140" style="margin-right:20px;"/>'
    if logo_b64 else ""
)
...
if logo_b64:
    st.sidebar.markdown(
        f'<img src="data:image/jpeg;base64,{logo_b64}" width="140" style="display:block; margin:0 auto 16px auto;"/>',
        unsafe_allow_html=True
    )
